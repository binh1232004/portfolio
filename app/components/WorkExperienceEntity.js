export default function WorkExperienceEntity({ date, title, description, company }) {
  return (
    <div className="flex items-center">
      ...
      <div className="ml-32 md:ml-40 w-full max-w-md group">
        <div className="relative overflow-hidden rounded-xl shadow-2xl transform transition-all duration-500 hover:scale-110 hover:rotate-2 backdrop-blur-sm border border-orange-400/20"
          ...
          <div className="bg-gradient-to-br from-blue-200/90 via-indigo-100/90 to-purple-100/90 backdrop-blur-sm p-6 h-48 flex items-center justify-center relative overflow-hidden">
            ...
            <div className="text-center relative z-10">
              ...
              <div className="flex justify-center space-x-2">
                ...
                <div className="w-3 h-3 bg-indigo-500 rounded-full animate-bounce shadow-lg" style={{animationDelay: '0.1s'}}></div>
